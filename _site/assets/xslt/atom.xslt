...
<ul class="accordion row" data-accordion="">
    ...
    <div class="container vertical-divider">
      <div class="column one-half">
        <h5>Gold sponsors</h5>
        <img src="/2019/images/sponsors/cz-foundation/PNG/cz-cropped.png" alt="Chan Zuckerberg Initiative" width="32%">
        <img src="/2019/images/sponsors/facebook-cropped.png" alt="Facebook" width="32%">
        <img src="/2019/images/sponsors/google2.0.0.jpg" alt="Google" width="32%">
      </div>
      <div class="column one-third">
        <h5>Silver sponsors</h5>
	      <img src="/2019/images/sponsors/oracle-cropped.png" alt="Oracle Corporation" width="49%">
	      <img src="/2019/images/sponsors/diffbot-vertical-light-background@2x.png" alt="Diffbot" width="49%">
      </div>
      <div class="column one-sixth">
        <h5>Bronze sponsor</h5>
	      <img style="display:inline" src="/2019/images/sponsors/elsevier.jpeg" alt="Elsevier" width="90%" >
      </div>
    </div>
